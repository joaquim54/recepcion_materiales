    ...
    <div class="container">
        ...
        <div class="card card-body">
            ...
            <div class="text-center d-flex justify-content-center">
                ...
                <button class="btn btn-primary mr-2" id="btnLimpiar" role="button">
            ...
            <div class="card card-body">
                ...
                <div class="form-row mt-4">
                    <div class="col text-center">
                        ...
                        <button type="button" id="btnNuevaPlanilla" name="btnNuevaPlanilla" class="btn btn-secondary" role="button" aria-expanded="false" disabled>
                        <i class="fa-solid fa-file"></i> Actualizar planilla
                        </button>
                    </div>
                </div>
